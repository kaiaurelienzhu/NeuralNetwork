namespace NeuralNetwork
{
    ...
    public abstract class NNComponent : GH_Component
    {
        ...
        private static string pluginCategory = "NeuralNetwork"; // NeuralNetworkTODO: The Grasshopper tab that all components sit in
        ...
        protected NNComponent(string name, string nickname, string description, string subCategory)
        ...
        protected abstract void NeuralNetworkSolveInstance(IGH_DataAccess da);
