namespace NeuralNetwork
{
    ...
    using NeuralNetwork.SubCategory;
    using Rhino.Geometry;

    public class ghc_NeuralNetwork : NNComponent
    {
        /// <summary>
        ...
        /// </summary>
        public ghc_NeuralNetwork() : base(
            "Neural Network", "NN", "ETH Zurich Neural network course", "Util")
        {
        }
        ...
        protected override void NeuralNetworkSolveInstance(IGH_DataAccess da)
        {
